...
def get_dataloader(opt, dataset, review_data, vocab, review_id2entity) -> BaseDataLoader:
    ...
    if model_name in dataloader_register_table:
        return dataloader_register_table[model_name](opt, dataset, review_data, vocab, review_id2entity)
    else:
