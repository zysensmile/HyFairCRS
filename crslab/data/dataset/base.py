...
class BaseDataset(ABC):
    ...
    def __init__(self, opt, dpath, resource, restore=False, save=False):
        ...
        if not restore:
            ...
            self.train_data, self.valid_data, self.test_data, self.side_data, self.vocab, self.train_review, self.valid_review, self.test_review = self._load_from_restore()

        if save:
            data = (self.train_data, self.valid_data, self.test_data, self.side_data, self.vocab, self.train_review, self.valid_review, self.test_review)
