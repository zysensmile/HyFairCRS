...
class MHIMDataLoader(BaseDataLoader):
    ...
    def __init__(self, opt, dataset, review_data, vocab, review_id2entity):
        """
        ...
        self.review_id2entity = review_id2entity
    ...
    def _get_review(self, batch_conv_id):
        ...
        for conv_idx in batch_conv_id:
            conv_idx = str(conv_idx)
            if conv_idx in self.review_data:
                temp_review = self.review_data[conv_idx]
                ...
                selected_entityIds = []
            review_entitys = []
            for idx in selected_entityIds:
                try:
                    entity = self.review_entity2id[self.review_id2entity[idx]]
                    review_entitys.append(entity)
                except KeyError:
                    pass
            review["review_tokens"].append(selected_infoListListInt)
            review["review_entitys"].append(review_entitys)
        #     print("review_tokens", selected_infoListListInt)
        #     print("review_entitys", review_entitys)
        return review
